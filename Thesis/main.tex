...
\input{scraps/titlepage}

\doublespacing

\input{scraps/dedication}

\clearpage

\input{scraps/acknowledge}

\clearpage

\input{scraps/abstracts}
...
\input{appendices/noise}

\chapter{Gaussian Functional Integrals}
\input{appendices/gaussian}

\chapter{Binary Correlation Functions}
\label{binaryCs}
\input{appendices/binary_correlations}

\chapter{Algorithms}
\input{appendices/algorithm}
