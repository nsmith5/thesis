...
free energy functional in these new variables into two parts,
%
\begin{equation}
    \f{\beta\F[n, c]}{\rho_0} = \f{\beta\F_{id}[n, c]}{\rho_0} 
...
Differences in the various binary PFC theories stem from different
approximations of ideal free energy in equation \ref{binary_ideal} and excess
free energy in equation \ref{binary_excess}.
