...
\title{Generalization of the Binary Phase Field Crystal Model}
\author{Nathan Smith}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Generalization of the Binary Phase Field Crystal Model} %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure*}
    ...
    \caption{
        ...
        concentration $c = 0.3$ and relative density is set to $n = 0.05$.
        Mobilities $M_n$ and $M_c$ are set to 1 and $W_c$ is set to 3.0.
        Numerical parameters are grid spacing $\Delta x = 0.125$ on a 1024 by
        1024 lattice with time step size $\Delta t = 0.0025$. Sub-figures (a) -
        (d) show spinodal decomposition of the liquid and initial nucleation.
        Sub-figures (e) and (f) show further nucleation and solid growth at the
        expense of liquid regions.   
    }
\end{figure*}
%
...
concentration in the solute-rich regions of the decomposed liquid occurs,
nucleation of the solid phase begins to occur in these confined liquid volumes.
Once nucleated, the solid regions start/continue to grow at the expense of the
...
gathered statistics for the data shown below. As mentioned above, we observed
that once any solute-rich regions crystallize, their growth is accelerated at
the expense of uncrystallized solute-rich regions. We refer to this phenomena
as \textit{sacrificial growth} (frames (d)-(f) in figure \ref{fig:precipitation})). 
%
\begin{figure*}
    \centering
